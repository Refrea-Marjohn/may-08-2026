-- Fresh database for DepEd Loan System
-- Clean schema: keys/indexes/auto_increment defined directly in CREATE TABLE
-- Admin login:
...
DROP DATABASE IF EXISTS `provident_loan_system`;
CREATE DATABASE `provident_loan_system` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
-- Fresh database for DepEd Loan System
-- Keeps only one admin account
-- Admin password: Deped_2026
...
(1, 'sdoofcabuyao', 'sdoofcabuyao@gmail.com', '$2y$10$70pRi/fVTAY0dT.X6YSJieqWD.keu3UXu61AuqOJrAYYfPrvJRowK', 'SDO Cabuyao', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, 'active', NULL);
...
ALTER TABLE `audit_logs` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
ALTER TABLE `deductions` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
ALTER TABLE `fund_ledger` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
ALTER TABLE `loans` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
ALTER TABLE `loan_skip_months` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
ALTER TABLE `notifications` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
ALTER TABLE `password_reset_pending` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
ALTER TABLE `registration_pending` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
