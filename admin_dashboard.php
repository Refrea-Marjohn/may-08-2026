...
<head>
    ...
    <style>
        * {
        ...
        /* Explicit column sizing per table to avoid wasted space on mid-widths */
        .user-table--users th:nth-child(1),
        .user-table--users td:nth-child(1) { width: 7%; }
        .user-table--users th:nth-child(2),
        .user-table--users td:nth-child(2) { width: 34%; }
        .user-table--users th:nth-child(3),
        .user-table--users td:nth-child(3) { width: 33%; }
        .user-table--users th:nth-child(4),
        .user-table--users td:nth-child(4) { width: 26%; }

        .user-table--loans th:nth-child(1),
        .user-table--loans td:nth-child(1) { width: 34%; }
        .user-table--loans th:nth-child(2),
        .user-table--loans td:nth-child(2) { width: 20%; }
        .user-table--loans th:nth-child(3),
        .user-table--loans td:nth-child(3) { width: 24%; }
        .user-table--loans th:nth-child(4),
        .user-table--loans td:nth-child(4) { width: 22%; }
        ...
        @media (max-width: 700px) {
            ...
            /* Prevent huge blank gap under fixed navbar */
            .container {
            ...
            .sidebar-menu {
                padding: 0.4rem 0.4rem 0.8rem !important;
            }
            ...
            .sidebar-link {
                ...
                margin: 0.16rem 0.32rem !important;
                border-radius: 10px !important;
                gap: 0.56rem !important;
                font-size: 0.7rem !important;
            }

            /* Ensure mobile sidebar never uses collapsed styles (shared.css has min-width:601px rules) */
            .sidebar-title,
            .sidebar-user-meta,
            .sidebar-badge,
            ...
            /* Match Reports: show user card at bottom on mobile */
            .sidebar-user-card {
            ...
            .dashboard-grid.tables-grid .content-section {
                overflow-x: auto;
        ...
        @media (max-width: 480px) {
            ...
            .dashboard-grid.tables-grid .user-table {
                min-width: 620px;
            }
        }

        /* Small/medium tablet: desktop-like header/sidebar, stacked heavy content */
        @media (min-width: 701px) and (max-width: 900px) {
            ...
            /* Between mobile and tablet: consume full card width */
            .dashboard-grid.tables-grid .user-table {
                width: 100% !important;
            ...
            .dashboard-grid.tables-grid .user-table th,
            .dashboard-grid.tables-grid .user-table td {
                white-space: normal;
...
<body>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <div class="dashboard-grid tables-grid">
                <div class="content-section">
                    <h2 class="section-title"><i class="fas fa-users"></i> Recent User Registrations</h2>
                    <table class="user-table user-table--users">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                ...
                <div class="content-section">
                    ...
                    <table class="user-table user-table--loans">
                        <thead>
                            <tr>
                                <th>Applicant</th>
                                <th>Amount</th>
